...
public class GroupMeIMConnection extends AbstractIMConnection {
	 ...
	 *            The Authentication of the GroupMeConnection
	 */
	...
	/**
	 * Sets up the class IMBot and makes a new GroupMeChat. The requirements for
	 * the plugin to run.
	 */
	...
	public static void registerGroupMeBot() {
		...
		if (storedId.equals("")) {
			...
			GroupMeBot.initWithBotId(storedId, GroupMeStoredData.getGroupMeBotName(),
					GroupMeStoredData.getGroupMeToken(), GroupMeStoredData.getGroupMeGroupId(),
					new GroupMeBotConnection(GroupMeStoredData.getGroupMeToken()));
		}
	}
